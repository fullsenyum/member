                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="tglahir" type="date" class="form-control @error('tglahir') is-invalid @enderror" name="tglahir" value="{{ old('tglahir') }}" required autocomplete="tglahir" autofocus>
